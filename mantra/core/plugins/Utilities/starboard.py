...
from mantra.core.utils import Colors,Emojis,CommandError
...
@lightbulb.option("channel", "The channel to set as starboard channel", type=hikari.GuildChannel, channel_types=hikari.ChannelType.GUILD_TEXT)
...
async def configure_command(ctx: lightbulb.Context, channel: hikari.GuildTextChannel, threshold: int) -> None:
